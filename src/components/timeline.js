                            ...
                            <ul className="timeline">
                                <li>
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record" data-tip="" data-for="tip1"></i></a>
                                    </div>
                                    ...
                                    <div className="timeline-panel">
                                        <div className="timeline-heading">
                                            <img className="img-responsive" src="http://lorempixel.com/1600/500/sports/2" alt=""/>
                                        </div>
                                        <div className="timeline-body">
                                            <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga. Sapien in monti palavris qui num significa nadis i pareci latim. Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.</p>
                                        </div>
                                        <div className="timeline-footer">
                                            <a href="!#"><i className="glyphicon glyphicon-thumbs-up"></i></a>
                                            <a href="!#"><i className="glyphicon glyphicon-share"></i></a>
                                            <a href="!#" className="pull-right">Continuar Lendo</a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li className="timeline-inverted">
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record invert" data-tip="" data-for="tip2"></i></a>
                                    </div>
                                ...
                                <li>
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record" data-tip="" data-for="tip3"></i></a>
                                    </div>
                                ...
                                <li  className="timeline-inverted">
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record invert" data-tip="" data-for="tip4"></i></a>
                                    </div>
                                ...
                                <li>
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record" data-tip="" data-for="tip5"></i></a>
                                    </div>
                                ...
                                <li  className="timeline-inverted">
                                    <div className="timeline-badge primary">
                                        <a href="!#"><i className="glyphicon glyphicon-record invert" data-tip="" data-for="tip6"></i></a>
                                    </div>
